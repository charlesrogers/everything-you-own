  ...
  return useMemo(() => {
    if (!USE_SUPABASE) {
      ...
      return {
        ...
        updateProductLocation: async (id: string, updates: { quantity?: number; notes?: string | null }) => { /* no-op for local */ },
    ...
    return {
      ...
      updateProductLocation: (id: string, updates: { quantity?: number; notes?: string | null }) => wmsStore.updateProductLocation(sb, id, updates),
